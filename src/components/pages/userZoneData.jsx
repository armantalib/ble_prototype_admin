...
const UserZoneData = (props) => {
    ...
    const StatusToggler = ({ row }) => {
        ...
        const handleToggle = async () => {
            ...
            const endPoint = `general/user/hazard/privacy`
    ...
    const fetchData = async () => {
        ...
        try {
            let allData = [];
            let data1 = {}
            const endPoint = `general/admin/hazard/${currentPage}?category=${selectedCategory}&search=${search}`;
    ...
    const deleteData = async (id) => {
        if (window.confirm("Are you sure to want delete")) {
            let data1 = {}
            const endPoint = `general/admin/hazard/update/${id}/removed`
            const res = await dataPut(endPoint, {});
            fetchData()
        }
    }
            ...
            <main className="min-h-screen lg:container py-5 px-4 mx-auto">
                ...
                <div className="flex justify-between gap-3 items-center w-full">
                    <div className="flex flex-col mb-3 w-full">
                        <h2 className='plusJakara_bold text_black'>User Hazard</h2>
                    ...
                    {singleData ? (
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                            ...
                            <div>
                                ...
                                <p style={{ fontSize: 28 }}><strong>{singleData?.category?.icon}</strong></p>
                                <p><strong>Category:</strong> {singleData?.category?.title} → {singleData?.sub_category?.name}</p>
                            ...
                            {/* Price */}
                            <div>
                                <h6 className="mb-1">Risk:</h6>
                                <p><strong>Level:</strong> {singleData?.risk?.toLocaleString()}</p>
                                ...
                                <div>
                                    ...
                                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px' }}>
                                        ...
                                        <img
                                            ...
                                            onClick={() => setEnlargedImage(singleData?.image)}
                                            style={{
                                                width: 400,
                                                height: 200,
                                                borderRadius: 10,
...
const marketplaceCategories =
    [
        {
            id: '1',
            name: 'Road Condition & Infrastructure Hazards',
        ...
        {
            id: '2',
            name: 'Traffic & Driver Awareness Issues',
